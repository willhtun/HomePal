...
public class Custom4 extends AppCompatActivity {
    ...
    public void loadHousemates() {
        int text[] = {R.id.custom4_person1_text, R.id.custom4_person2_text, R.id.custom4_person3_text, R.id.custom4_person4_text, R.id.custom4_person5_text};
        for (int i = 1; i < 6; i++) {
    ...
    public void loadButtons() {
        ...
        if (preferences.getBoolean("settings_billSharingOn_custom4", false)) {
            final int text[] = {R.id.custom4_person1_text, R.id.custom4_person2_text, R.id.custom4_person3_text, R.id.custom4_person4_text, R.id.custom4_person5_text};
            final ImageView button [] = {custom4_p1_btn, custom4_p2_btn, custom4_p3_btn, custom4_p4_btn, custom4_p5_btn};
            ...
            for (int i = 1;i < 6; i++) {
                if (!preferences.getBoolean("housemate" + i + "_On", false)) {
                    ...
                    button[i-1].setOnLongClickListener(new View.OnLongClickListener() {
                        @Override
                        public boolean onLongClick(View v) {
                            custom4_personX_pay(person_nump_temp, button[person_nump_temp-1], text[person_nump_temp-1]);
                            return true;
                        }
                    });
                }
    ...
    public void loadHistory() {
        LinearLayout vertical_ll = findViewById(R.id.custom4_history);
