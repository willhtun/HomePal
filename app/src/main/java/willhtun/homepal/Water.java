...
public class Water extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        water_p0_btn = (ImageView) findViewById(R.id.water_payBtn);
        water_p1_btn = (ImageView) findViewById(R.id.water_person1);
        water_p2_btn = (ImageView) findViewById(R.id.water_person2);
        water_p3_btn = (ImageView) findViewById(R.id.water_person3);
        water_p4_btn = (ImageView) findViewById(R.id.water_person4);
        water_p5_btn = (ImageView) findViewById(R.id.water_person5);

        ((TextView) findViewById(R.id.water_dueDate)).setText("Due: " + duemonth + "/" + duedate);
        ((TextView) findViewById(R.id.water_cost)).setText("$ " + String.valueOf(mDatabaseHelper.getCost_fromDueDate(type)));
    ...
    public void water_pay() {
        ...
        water_p0_btn.setImageResource(R.drawable.water_paybutton);
        loadHistory();
    }
    ...
    public void water_person1_pay() {
        ...
        water_p1_btn.setImageResource(R.drawable.water_personpaidbutton);
        loadHistory();
    }
    ...
    public void water_person2_pay() {
        ...
        water_p2_btn.setImageResource(R.drawable.water_personpaidbutton);
        loadHistory();
    }
    ...
    public void water_person3_pay() {
        ...
        water_p3_btn.setImageResource(R.drawable.water_personpaidbutton);
        loadHistory();
    }
    ...
    public void water_person4_pay() {
        ...
        water_p4_btn.setImageResource(R.drawable.water_personpaidbutton);
        loadHistory();
    }
    ...
    public void water_person5_pay() {
        ...
        water_p5_btn.setImageResource(R.drawable.water_personpaidbutton);
        loadHistory();
    }
