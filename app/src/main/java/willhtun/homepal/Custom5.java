...
public class Custom5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (temp_price == "") {
            price = 0;
            ((TextView) findViewById(R.id.custom5_priceboxtext)).setText("$0.00");
        }
        else {
            price = Float.valueOf(temp_price);
            ((TextView) findViewById(R.id.custom5_priceboxtext)).setText("$" + String.format("%.2f", price));
        }
        ...
        preferences.edit().putBoolean("overdue_custom5", true).apply();
    ...
    public void custom5_person1_pay() {
        ...
        ((TextView) findViewById(R.id.custom5_person1_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void custom5_person2_pay() {
        ...
        ((TextView) findViewById(R.id.custom5_person2_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void custom5_person3_pay() {
        ...
        ((TextView) findViewById(R.id.custom5_person3_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void custom5_person4_pay() {
        ...
        ((TextView) findViewById(R.id.custom5_person4_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void custom5_person5_pay() {
        ...
        ((TextView) findViewById(R.id.custom5_person5_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void loadHousemates() {
        ...
        ((TextView) findViewById(R.id.custom5_person1_text)).setText(name1);
        ((TextView) findViewById(R.id.custom5_person2_text)).setText(name2);
        ((TextView) findViewById(R.id.custom5_person3_text)).setText(name3);
        ((TextView) findViewById(R.id.custom5_person4_text)).setText(name4);
        ((TextView) findViewById(R.id.custom5_person5_text)).setText(name5);
    }
    ...
    public void loadButtons() {
        if (mDatabaseHelper.isDataExists_fromHistory(type, mCalendarHelper.getCycleMonthYear(type),0)) {
            ...
            custom5_p0_btn.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
        ...
        if (preferences.getBoolean("settings_billSharingOn_custom5", false)) {
            if (!preferences.getBoolean("housemate1_On", false)) {
                custom5_p1_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom5_person1_text)).setText("");
            }
                ...
                custom5_p1_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate2_On", false)) {
                custom5_p2_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom5_person2_text)).setText("");
            }
                ...
                custom5_p2_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate3_On", false)) {
                custom5_p3_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom5_person3_text)).setText("");
            }
                ...
                custom5_p3_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate4_On", false)) {
                custom5_p4_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom5_person4_text)).setText("");
            }
                ...
                custom5_p4_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate5_On", false)) {
                custom5_p5_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom5_person5_text)).setText("");
            }
                ...
                custom5_p5_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            findViewById(R.id.custom5_payButtonsContainer).setVisibility(View.GONE);
        }
    }

    public void loadHistory() {
        LinearLayout ll = findViewById(R.id.custom5_history);
        ll.removeAllViews();
        String[][] text_raw = mDatabaseHelper.getPaidDate_fromHistory(type);

        preferences.edit().putBoolean("overdue_custom5", false).apply();
                ...
                */
                ...
                if (overdue_exist) {
                    ...
                    duesButton.setOnClickListener(new ArgsOnClickListener(this, history_price, type_period, format_period, personsPaidStats) {
                        @Override
                        public void onClick(View v) {
                            final AlertDialog.Builder pastDues_builder = new AlertDialog.Builder(Custom5.this);
                    ...
                    duesButton.setOnClickListener(new ArgsOnClickListener(this, history_price, type_period, format_period, personsPaidStats) {
                        @Override
                        public void onClick(View v) {
                            AlertDialog.Builder pastDues_builder = new AlertDialog.Builder(Custom5.this);
    ...
    public void show_pricePicker(View view) {
        AlertDialog.Builder pricePicker_Builder = new AlertDialog.Builder(Custom5.this);
    ...
    public void setPricePicker(View view) {
        ((TextView) findViewById(R.id.custom5_priceboxtext)).setText("$" + et_pricebox.getText());
