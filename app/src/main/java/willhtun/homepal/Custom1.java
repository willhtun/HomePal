...
public class Custom1 extends AppCompatActivity {
    ...
    public void custom1_person1_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 111, 1, price);
        custom1_p1_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom1_person1_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom1_person2_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 222, 2, price);
        custom1_p2_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom1_person2_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom1_person3_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 333, 3, price);
        custom1_p3_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom1_person3_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom1_person4_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 444, 4, price);
        custom1_p4_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom1_person4_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom1_person5_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 555, 5, price);
        custom1_p5_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom1_person5_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void loadHousemates() {
        ...
        ((TextView) findViewById(R.id.custom1_person1_text)).setText(name1);
        ((TextView) findViewById(R.id.custom1_person2_text)).setText(name2);
        ((TextView) findViewById(R.id.custom1_person3_text)).setText(name3);
        ((TextView) findViewById(R.id.custom1_person4_text)).setText(name4);
        ((TextView) findViewById(R.id.custom1_person5_text)).setText(name5);
    }
    ...
    public void loadButtons() {
        if (mDatabaseHelper.isDataExists_fromHistory(type, mCalendarHelper.getCycleMonthYear(type),0)) {
            ...
            ((TextView) findViewById(R.id.custom1_payBtn_text)).setTextColor(Color.parseColor("#5DB699"));
        }

        if (preferences.getBoolean("settings_billSharingOn_custom1", false)) {
            if (!preferences.getBoolean("housemate1_On", false)) {
                custom1_p1_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom1_person1_text)).setText("");
            }
                ...
                custom1_p1_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom1_p1_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom1_person1_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate2_On", false)) {
                custom1_p2_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom1_person2_text)).setText("");
            }
                ...
                custom1_p2_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom1_p2_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom1_person2_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate3_On", false)) {
                custom1_p3_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom1_person3_text)).setText("");
            }
                ...
                custom1_p3_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom1_p3_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom1_person3_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate4_On", false)) {
                custom1_p4_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom1_person4_text)).setText("");
            }
                ...
                custom1_p4_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom1_p4_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom1_person4_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate5_On", false)) {
                custom1_p5_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom1_person5_text)).setText("");
            }
                ...
                custom1_p5_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom1_p5_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom1_person5_pay();
                        return true;
    ...
    public void loadHistory() {
        LinearLayout ll = findViewById(R.id.custom1_history);
        ll.removeAllViews();
