...
public class Custom1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.custom1_title)).setText(preferences.getString("name_preference_bills_custom1", "Custom 1"));
        if (preferences.getString("name_preference_bills_custom1", "Custom 1").equals(""))
            ((TextView)findViewById(R.id.custom1_title)).setText("Custom 1");
    ...
    public void change_history() {
        AlertDialog.Builder historyChanger_Builder = new AlertDialog.Builder(Custom1.this);
    ...
    public void loadHistory() {
        /*
        TextView history1 = (TextView) findViewById(R.id.custom1_paidDate1);
        history1.setText(mDatabaseHelper.getPaidDate_fromHistory(type, duemonth-3, dueyear)[2]);
        if (history1.getText() == "")
            findViewById(R.id.custom1_paidDate1_bullet).setVisibility(View.INVISIBLE);
        else {
        ...
        TextView history2 = (TextView) findViewById(R.id.custom1_paidDate2);
        history2.setText(mDatabaseHelper.getPaidDate_fromHistory(type, duemonth-2, dueyear)[1]);
        if (history2.getText() == "")
            findViewById(R.id.custom1_paidDate2_bullet).setVisibility(View.INVISIBLE);
        else {
            history1.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
        ...
        TextView history3 = (TextView) findViewById(R.id.custom1_paidDate3);
        history3.setText(mDatabaseHelper.getPaidDate_fromHistory(type, duemonth-1, dueyear)[0]);
        if (history3.getText() == "")
            findViewById(R.id.custom1_paidDate3_bullet).setVisibility(View.INVISIBLE);
        else {
            history1.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
