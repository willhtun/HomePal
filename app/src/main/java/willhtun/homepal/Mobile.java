...
public class Mobile extends AppCompatActivity {
    ...
    public void mobile_person1_pay() {
        ...
        ((TextView) findViewById(R.id.mobile_person1_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void mobile_person2_pay() {
        ...
        ((TextView) findViewById(R.id.mobile_person2_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void mobile_person3_pay() {
        ...
        ((TextView) findViewById(R.id.mobile_person3_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void mobile_person4_pay() {
        ...
        ((TextView) findViewById(R.id.mobile_person4_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void mobile_person5_pay() {
        ...
        ((TextView) findViewById(R.id.mobile_person5_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void loadHousemates() {
        ...
        ((TextView) findViewById(R.id.mobile_person1_text)).setText(name1);
        ((TextView) findViewById(R.id.mobile_person2_text)).setText(name2);
        ((TextView) findViewById(R.id.mobile_person3_text)).setText(name3);
        ((TextView) findViewById(R.id.mobile_person4_text)).setText(name4);
        ((TextView) findViewById(R.id.mobile_person5_text)).setText(name5);
    }
    ...
    public void loadButtons() {
        ...
        if (preferences.getBoolean("settings_billSharingOn_mobile", false)) {
            if (!preferences.getBoolean("housemate1_On", false)) {
                mobile_p1_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.mobile_person1_text)).setText("");
            }
                ...
                mobile_p1_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate2_On", false)) {
                mobile_p2_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.mobile_person2_text)).setText("");
            }
                ...
                mobile_p2_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate3_On", false)) {
                mobile_p3_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.mobile_person3_text)).setText("");
            }
                ...
                mobile_p3_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate4_On", false)) {
                mobile_p4_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.mobile_person4_text)).setText("");
            }
                ...
                mobile_p4_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate5_On", false)) {
                mobile_p5_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.mobile_person5_text)).setText("");
            }
                ...
                mobile_p5_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void loadHistory() {
        LinearLayout ll = findViewById(R.id.mobile_history);
        ll.removeAllViews();
