...
public class Internet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        internet_p0_btn = findViewById(R.id.internet_payBtn);
        internet_p1_btn = findViewById(R.id.internet_person1);
        internet_p2_btn = findViewById(R.id.internet_person2);
        internet_p3_btn = findViewById(R.id.internet_person3);
        internet_p4_btn = findViewById(R.id.internet_person4);
        internet_p5_btn = findViewById(R.id.internet_person5);
        ...
        if (temp_price == "") {
            price = 0;
            ((TextView) findViewById(R.id.internet_priceboxtext)).setText("$0.00");
        }
        else {
            price = Float.valueOf(temp_price);
            ((TextView) findViewById(R.id.internet_priceboxtext)).setText("$" + String.format("%.2f", price));
        }
        ...
        preferences.edit().putBoolean("overdue_internet", true).apply();
    ...
    public void internet_pay() {
        ...
        internet_p0_btn.setImageResource(R.drawable.generic_paidbutton);
        loadHistory();
    }
    ...
    public void internet_person1_pay() {
        ...
        internet_p1_btn.setImageResource(R.drawable.generic_personpaidbutton);
    ...
    public void internet_person2_pay() {
        ...
        internet_p2_btn.setImageResource(R.drawable.generic_personpaidbutton);
    ...
    public void internet_person3_pay() {
        ...
        internet_p3_btn.setImageResource(R.drawable.generic_personpaidbutton);
    ...
    public void internet_person4_pay() {
        ...
        internet_p4_btn.setImageResource(R.drawable.generic_personpaidbutton);
    ...
    public void internet_person5_pay() {
        ...
        internet_p5_btn.setImageResource(R.drawable.generic_personpaidbutton);
    ...
    public void loadHousemates() {
        ...
        ((TextView) findViewById(R.id.internet_person1_text)).setText(name1);
        ((TextView) findViewById(R.id.internet_person2_text)).setText(name2);
        ((TextView) findViewById(R.id.internet_person3_text)).setText(name3);
        ((TextView) findViewById(R.id.internet_person4_text)).setText(name4);
        ((TextView) findViewById(R.id.internet_person5_text)).setText(name5);
    }
    ...
    public void loadButtons() {
        if (mDatabaseHelper.isDataExists_fromHistory(type, mCalendarHelper.getCycleMonthYear(type),0)) {
            ...
            internet_p0_btn.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
            ...
            ((TextView) findViewById(R.id.internet_payBtn_text)).setTextColor(Color.parseColor("#5DB699"));
        }

        if (preferences.getBoolean("settings_billSharingOn_internet", false)) {
            if (!preferences.getBoolean("housemate1_On", false)) {
                internet_p1_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.internet_person1_text)).setText("");
            }
                ...
                internet_p1_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate2_On", false)) {
                internet_p2_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.internet_person2_text)).setText("");
            }
                ...
                internet_p2_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate3_On", false)) {
                internet_p3_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.internet_person3_text)).setText("");
            }
                ...
                internet_p3_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate4_On", false)) {
                internet_p4_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.internet_person4_text)).setText("");
            }
                ...
                internet_p4_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            if (!preferences.getBoolean("housemate5_On", false)) {
                internet_p5_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.internet_person5_text)).setText("");
            }
                ...
                internet_p5_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            findViewById(R.id.internet_payButtonsContainer).setVisibility(View.GONE);
        }
    }

    public void loadHistory() {
        LinearLayout ll = findViewById(R.id.internet_history);
        ll.removeAllViews();
        String[][] text_raw = mDatabaseHelper.getPaidDate_fromHistory(type);

        preferences.edit().putBoolean("overdue_internet", false).apply();
                ...
                */
                ...
                if (overdue_exist) {
                    ...
                    duesButton.setOnClickListener(new ArgsOnClickListener(this, history_price, type_period, format_period, personsPaidStats) {
                        @Override
                        public void onClick(View v) {
                            final AlertDialog.Builder pastDues_builder = new AlertDialog.Builder(Internet.this);
                    ...
                    duesButton.setOnClickListener(new ArgsOnClickListener(this, history_price, type_period, format_period, personsPaidStats) {
                        @Override
                        public void onClick(View v) {
                            AlertDialog.Builder pastDues_builder = new AlertDialog.Builder(Internet.this);
    ...
    public void show_pricePicker(View view) {
        AlertDialog.Builder pricePicker_Builder = new AlertDialog.Builder(Internet.this);
    ...
    public void setPricePicker(View view) {
        ((TextView) findViewById(R.id.internet_priceboxtext)).setText("$" + et_pricebox.getText());
