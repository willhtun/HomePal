...
public class Trash extends AppCompatActivity {
    ...
    public void loadHousemates() {
        int text[] = {R.id.trash_person1_text, R.id.trash_person2_text, R.id.trash_person3_text, R.id.trash_person4_text, R.id.trash_person5_text};
        for (int i = 1; i < 6; i++) {
    ...
    public void loadButtons() {
        ...
        if (preferences.getBoolean("settings_billSharingOn_trash", false)) {
            final int text[] = {R.id.trash_person1_text, R.id.trash_person2_text, R.id.trash_person3_text, R.id.trash_person4_text, R.id.trash_person5_text};
            final ImageView button [] = {trash_p1_btn, trash_p2_btn, trash_p3_btn, trash_p4_btn, trash_p5_btn};
            ...
            for (int i = 1;i < 6; i++) {
                if (!preferences.getBoolean("housemate" + i + "_On", false)) {
                    ...
                    button[i-1].setOnLongClickListener(new View.OnLongClickListener() {
                        @Override
                        public boolean onLongClick(View v) {
                            trash_personX_pay(person_nump_temp, button[person_nump_temp-1], text[person_nump_temp-1]);
                            return true;
                        }
                    });
                }
    ...
    public void loadHistory() {
        LinearLayout vertical_ll = findViewById(R.id.trash_history);
