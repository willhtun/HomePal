...
public class Custom3 extends AppCompatActivity {
    ...
    ImageView custom3_p0_btn;
    ImageView custom3_p1_btn;
    ImageView custom3_p2_btn;
    ImageView custom3_p3_btn;
    ImageView custom3_p4_btn;
    ImageView custom3_p5_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custom3_p0_btn = findViewById(R.id.custom3_payBtn);
        custom3_p1_btn = findViewById(R.id.custom3_person1);
        custom3_p2_btn = findViewById(R.id.custom3_person2);
        custom3_p3_btn = findViewById(R.id.custom3_person3);
        custom3_p4_btn = findViewById(R.id.custom3_person4);
        custom3_p5_btn = findViewById(R.id.custom3_person5);

        // Populate screen with information
        ((TextView) findViewById(R.id.custom3_dueDate)).setText("Due: " + duemonth + "/" + duedate);
        String temp_price = mDatabaseHelper.getMostRecentPrice_fromHistory(type);
        if (temp_price == "") {
            price = 0;
            ((TextView) findViewById(R.id.custom3_priceboxtext)).setText("$0.00");
        }
        else {
            price = Float.valueOf(temp_price);
            ((TextView) findViewById(R.id.custom3_priceboxtext)).setText("$" + String.format("%.2f", price));
        }
        ...
        preferences.edit().putBoolean("overdue_custom3", true).apply();
    ...
    public void custom3_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), mCalendarHelper.getTodayDate(), 0, price);
        ((TextView) findViewById(R.id.custom3_payBtn_text)).setText("PAID");
        ((TextView) findViewById(R.id.custom3_payBtn_text)).setTextColor(Color.WHITE);
        custom3_p0_btn.setImageResource(R.drawable.generic_paidbutton);
        loadHistory();
    }

    public void custom3_person1_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 111, 1, price);
        custom3_p1_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom3_person1_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom3_person2_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 222, 2, price);
        custom3_p2_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom3_person2_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom3_person3_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 333, 3, price);
        custom3_p3_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom3_person3_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom3_person4_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 444, 4, price);
        custom3_p4_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom3_person4_text)).setTextColor(Color.WHITE);
        loadHistory();
    }

    public void custom3_person5_pay() {
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), 555, 5, price);
        custom3_p5_btn.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(R.id.custom3_person5_text)).setTextColor(Color.WHITE);
        loadHistory();
    }
    ...
    public void loadHousemates() {
        ...
        ((TextView) findViewById(R.id.custom3_person1_text)).setText(name1);
        ((TextView) findViewById(R.id.custom3_person2_text)).setText(name2);
        ((TextView) findViewById(R.id.custom3_person3_text)).setText(name3);
        ((TextView) findViewById(R.id.custom3_person4_text)).setText(name4);
        ((TextView) findViewById(R.id.custom3_person5_text)).setText(name5);
    }
    ...
    public void loadButtons() {
        if (mDatabaseHelper.isDataExists_fromHistory(type, mCalendarHelper.getCycleMonthYear(type),0)) {
            ...
            custom3_p0_btn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                }
            });
            custom3_p0_btn.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
            ...
            ((TextView) findViewById(R.id.custom3_payBtn_text)).setTextColor(Color.parseColor("#5DB699"));
        }

        if (preferences.getBoolean("settings_billSharingOn_custom3", false)) {
            if (!preferences.getBoolean("housemate1_On", false)) {
                custom3_p1_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom3_person1_text)).setText("");
            }
                ...
                custom3_p1_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom3_p1_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom3_person1_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate2_On", false)) {
                custom3_p2_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom3_person2_text)).setText("");
            }
                ...
                custom3_p2_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom3_p2_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom3_person2_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate3_On", false)) {
                custom3_p3_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom3_person3_text)).setText("");
            }
                ...
                custom3_p3_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom3_p3_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom3_person3_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate4_On", false)) {
                custom3_p4_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom3_person4_text)).setText("");
            }
                ...
                custom3_p4_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom3_p4_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom3_person4_pay();
                        return true;
            ...
            if (!preferences.getBoolean("housemate5_On", false)) {
                custom3_p5_btn.setImageResource(R.drawable.generic_personunavailable);
                ((TextView) findViewById(R.id.custom3_person5_text)).setText("");
            }
                ...
                custom3_p5_btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(getApplicationContext(), "Press and hold to pay", Toast.LENGTH_SHORT).show();
                    }
                });
                custom3_p5_btn.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        custom3_person5_pay();
                        return true;
            ...
            findViewById(R.id.custom3_payButtonsContainer).setVisibility(View.GONE);
        }
    }

    public void loadHistory() {
        LinearLayout ll = findViewById(R.id.custom3_history);
        ll.removeAllViews();
        String[][] text_raw = mDatabaseHelper.getPaidDate_fromHistory(type);

        preferences.edit().putBoolean("overdue_custom3", false).apply();
                ...
                */
                ...
                if (overdue_exist) {
                    ...
                    duesButton.setOnClickListener(new ArgsOnClickListener(this, history_price, type_period, format_period, personsPaidStats) {
                        @Override
                        public void onClick(View v) {
                            final AlertDialog.Builder pastDues_builder = new AlertDialog.Builder(Custom3.this);
                    ...
                    duesButton.setOnClickListener(new ArgsOnClickListener(this, history_price, type_period, format_period, personsPaidStats) {
                        @Override
                        public void onClick(View v) {
                            AlertDialog.Builder pastDues_builder = new AlertDialog.Builder(Custom3.this);
    ...
    public void show_pricePicker(View view) {
        AlertDialog.Builder pricePicker_Builder = new AlertDialog.Builder(Custom3.this);
    ...
    public void setPricePicker(View view) {
        ((TextView) findViewById(R.id.custom3_priceboxtext)).setText("$" + et_pricebox.getText());
