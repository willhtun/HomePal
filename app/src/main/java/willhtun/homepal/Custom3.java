...
public class Custom3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.home_title)).setText(preferences.getString("name_preference_bills_custom3", "Custom 3"));
    ...
    public void custom3_personX_pay(int personNum, ImageView custom3_pX_button, int custom3_buttontextID) { //R.id.custom3_person1_text
        mDatabaseHelper.addData_toHistory(type, mCalendarHelper.getCycleMonthYear(type), personNum, personNum, price);
        custom3_pX_button.setImageResource(R.drawable.generic_personpaidbutton);
        ((TextView) findViewById(custom3_buttontextID)).setTextColor(Color.BLACK);
        loadHistory();
    }

    public void loadHousemates() {
        int text[] = {R.id.custom3_person1_text, R.id.custom3_person2_text, R.id.custom3_person3_text, R.id.custom3_person4_text, R.id.custom3_person5_text};
        for (int i = 1; i < 6; i++) {
    ...
    public void loadButtons() {
        if (mDatabaseHelper.isDataExists_fromHistory(type, mCalendarHelper.getCycleMonthYear(type),0)) {
            ...
            ((TextView) findViewById(R.id.custom3_payBtn_text)).setTextColor(Color.parseColor("#AAAAAA"));
        }

        if (preferences.getBoolean("settings_billSharingOn_custom3", false)) {
            final int text[] = {R.id.custom3_person1_text, R.id.custom3_person2_text, R.id.custom3_person3_text, R.id.custom3_person4_text, R.id.custom3_person5_text};
            final ImageView button [] = {custom3_p1_btn, custom3_p2_btn, custom3_p3_btn, custom3_p4_btn, custom3_p5_btn};
            ...
            for (int i = 1;i < 6; i++) {
                if (!preferences.getBoolean("housemate" + i + "_On", false)) {
                    ...
                    button[i-1].setOnLongClickListener(new View.OnLongClickListener() {
                        @Override
                        public boolean onLongClick(View v) {
                            custom3_personX_pay(person_nump_temp, button[person_nump_temp-1], text[person_nump_temp-1]);
                            return true;
                        }
                    });
                }
    ...
    public void loadHistory() {
        LinearLayout vertical_ll = findViewById(R.id.custom3_history);
